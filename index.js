...
/*Task 1: counterMaker()
  ...
  counter 1 is a closure, counter 2 is garbage collection
  2. Which of the two uses a closure? How can you tell?
  Counter 1 is a closure because the const outside of the function saying that the new counter is creating is keeping track of counterMaker 
  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  
     the first scenario seems like a much better preferance for when you want your code to remember what its referring to. Not sure what you would want to use the second one for 
*/
